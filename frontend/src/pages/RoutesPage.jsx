...
import { Pencil, Trash2, Route as RouteIcon, Clock } from "lucide-react";
...
const SLOT_SHORT = { presto: "Presto", standard: "Standard", pomeriggio: "Pomeriggio" };
const EMPTY = { name: "", code: "", zone: "", vehicle_id: "", slot: "presto", days: [0, 1, 2, 3, 4, 5] };
...
export default function RoutesPage() {
  ...
  const openEdit = (r) => { setEditing(r); setForm({ name: r.name, code: r.code, zone: r.zone, vehicle_id: r.vehicle_id, slot: r.slot, days: r.days || [] }); setOpen(true); };
